...
def InitGL(Width, Height):				# We call this right after our OpenGL window is created.
    LoadTexture()
#    imagetexture.load("bluecloth09.bmp")  # not working for me!!!
...
def DrawGLScene():
   ...
   # glTexCoord2f(0.0, 0.0); glVertex3f(0.0, 0.0,  1.0)	# Bottom Left Of The Texture and Quad
   # glTexCoord2f(1.0, 0.0); glVertex3f( 0.0, 4.0,  1.0)	# Bottom Right Of The Texture and Quad
   # glTexCoord2f(1.0, 1.0); glVertex3f( 4.0,  3.0, 1.0)# Top Right Of The Texture and Quad
   # glTexCoord2f(0.0, 1.0); glVertex3f(0.0,  3.0,  1.0)	# Top Left Of The Texture and Quad
	# Front Face (note that the texture's corners have to match the quad's corners)
...
def main():
	...
	window = glutCreateWindow("pretty picture")
